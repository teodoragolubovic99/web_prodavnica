 ...
 const Nav = ({history}) => {
    ...
    return (
       <nav ref = {Nav}  className={`nav ${nav ? 'active' : ''}`} >
           <div className="logo"><Link to =''>Djekic&company store</Link></div>
            <ul className="navLinks" ref= {navLinks}>
                <NavLink to="/" exact  activeClassName='activlink' ><li>Početna</li></NavLink>
                <NavLink to="/shop" activeClassName='activlink' ><li>Prodavnica</li></NavLink>
                <NavLink to="/contactus"activeClassName='activlink' ><li>Kontakt</li></NavLink>
                <NavLink to="/about" activeClassName='activlink'><li>O nama</li></NavLink>  
            </ul>
        ...
        <Route render={({history}) => <Searchnav history ={history}/>}/>
                ...
                <div className='dotcart'>
                    {incart}
                            ...
                            ) : <Link to='/login' > <div className='signin' onMouseOver={ () => setSignin(!signin)}  onMouseOut={ ()=> setSignin(!signin) }  > Login
