        ...
        <div className="footerCmp">
            <footer>
                <div className="footerCategorie">
                    <h1>Categories</h1>
                    <ul>
                        <li><Link to = '/shop/?cg=Women'>Womens</Link></li>
                ...
                <div className="footerGetInTouch">
                    <h1>Get in touch</h1>
                    <ul>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam eveniet quisquam reiciendis provident, quia impedit magni rerum dolorum atque sapiente a fugit ad praesentium placeat dignissimos eum, dolorem velit in.</p>
                ...
                <div className="footerNews">
                    ...
                    <ul>
                        ...
                        <li>
                            <button className="footerBtn">Newsletter</button>
                        </li>
                    </ul>
                </div>
